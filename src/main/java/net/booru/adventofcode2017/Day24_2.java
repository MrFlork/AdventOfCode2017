...
class Day24_2
{
    ...
    {
        //test();
        final int value = part2(Files.readAllLines(Paths.get("day24.in")));

        System.out.println("part2: " + value);
    }

    static int part2(final List<String> strings)
    {
        ...
        final Bridge bridge = allBridges.stream().max(Comparator.comparing(Bridge::getLength).thenComparing(Bridge::getStrength)).get();

        return bridge.getStrength();
    }
